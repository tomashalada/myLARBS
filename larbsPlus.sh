...
additionalinstall(){
	# Installs node needed for coc nvim and other custom features
	whiptail --infobox "Installing additional tools..." 7 60
	curl -sL install-node.vercel.app/lts | sh -s -- -P /home/$name/.local -y
}
...
# Install additional tools and settinigs
additionalinstall
